...
console.log（"*************************************"）
//Create
a new String and call the
function with our new input.
var my_string = string_class. $new("k3FELEG91noWbOateGhj5pX6QXRNJKh///8Jxi8KXW7iDpk2xRxhQ==");
console. log( "Original arg: " + x); // prints original argument to console
var ret = this.decrypt (my_string); // returns result from decrypt ()
console. log ("Return value:" + ret); // prints new return value to console
console.log（"*************************************"）
return ret;
//Find an instance of the class and call "decrypt" function.
Java. choose ("bnac. injuredandroid", l
onMatch: function (instance) {
console. log ("Found instance: " + instance) ; console. log ("Result of decrypt func:" + instance. decrypt());
onComplete: function () { }
}) ;
})；
